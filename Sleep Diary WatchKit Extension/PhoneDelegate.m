...
//  Sleep Diary
//
//  Created by Alexander Ivanov on 27.11.16.
...
- (void)session:(WCSession *)session didReceiveMessage:(NSDictionary<NSString *,id> *)message replyHandler:(nonnull void (^)(NSDictionary<NSString *,id> * _Nonnull))replyHandler {
	if ([message[STR_UNDERSCORE] isEqualToString:HKMetadataKeySampleActivities])
		[CMMotionActivitySample queryActivityStartingFromDate:message[KEY_TIMER_START] toDate:message[KEY_TIMER_END] within:GLOBAL.sleepLatency withHandler:^(NSArray<CMMotionActivitySample *> *activities) {
